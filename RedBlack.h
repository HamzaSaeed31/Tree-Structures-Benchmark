...
//bool RBsearch(RedBlackNode<Y>* root,X key)
//{
//    RedBlackNode<Y>* ptr = root;
//    while (ptr)
//    {
//        if (ptr->data == key)
//            return true;
...
void red_black()
{
    int option, search_op;
    cout << "enter the column number on which's base u want to execute indexing:\n1) ID\n2) Year\n3) 113 Cause\n4) Cause Name\n5) State\n6)Deaths\n7) Age-adjusted Death Rate\n" << endl;
    cin >> option;
    if (option == 1)
    {
